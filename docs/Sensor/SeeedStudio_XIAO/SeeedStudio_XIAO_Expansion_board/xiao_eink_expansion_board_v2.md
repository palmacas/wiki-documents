...
Put the `.h` file outputed from image2lcd into the same folder as example, and include it. Open image.h file and **copy the array name to EPD_WhiteScreen_ALL() function**.
